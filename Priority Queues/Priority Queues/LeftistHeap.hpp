...
public:
    ...
    void toString()  {toString(m_root," ",0);}; //helper function for to String
...
/*merges the left and right child of the root to remove the min. Returns root of previous heap*/
